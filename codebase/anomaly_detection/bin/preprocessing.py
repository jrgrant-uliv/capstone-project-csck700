...
class FeatureExtractor(object):
    """
    A class for extracting features from log sequences matrix.

    Attributes
    ----------
    idf_vec : ndarray, shape (num_event,)
        The inverse document frequency vector.
    mean_vec : ndarray, shape (1, num_event)
        The mean vector.
    events : list
        The list of unique events.
    term_weighting : str or None
        The type of term weighting used for feature extraction.
    normalization : str or None
        The type of normalization used for feature extraction.
    oov : bool
        Whether to use out-of-vocabulary (OOV) event.

    Methods
    -------
    fit_transform(X_seq, term_weighting=None, normalization=None, oov=False, min_count=1)
